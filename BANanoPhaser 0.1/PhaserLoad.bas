...
Sub sound(key As String, URL As String)
	Load.RunMethod("sound", Array(key, URL))
End Sub
...
Sub spritesheet(key As String, URL As String, frameWidth As Int, frameHeight As Int)
